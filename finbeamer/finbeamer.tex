...
\newcommand{\titleoldlogouni}{\def\titlelogo{\begin{figure}\includegraphics[height=55pt]{./slike/grb/unikg_oldlogo}\end{figure}}}
...
% \footlogouniold --- стари универзитетски лого
...
\ifnum\insertframenumber>0
    ...
    \end{tikzpicture}%
\fi}}
\newcommand{\footlogouni}{\footlogo{slike/grb/unikg_logo.png}}
\newcommand{\footoldlogouni}{\footlogo{slike/grb/unikg_oldlogo.pdf}}
